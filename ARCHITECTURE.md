...
```mermaid
flowchart TD
    UserQuery[User Query Input] --> Guardrail{Guardrail Classifier:<br>Topik Batu & Kristal?}
    Guardrail -- TIDAK --> Reject[Hardcode Rejection Response]
    Guardrail -- YA --> Synthesis[Multi-Aspect Synthesis Engine]
```
